...
architecture behav of reduce_1 is 
    ...
    signal grp_reduce_3_fu_524_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_3_fu_524_ap_ce : STD_LOGIC;
    ...
    signal grp_reduce_3_fu_592_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_3_fu_592_ap_ce : STD_LOGIC;
...
begin
    grp_reduce_3_fu_524 : component reduce_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_3_fu_524_ap_return,
        ap_ce => grp_reduce_3_fu_524_ap_ce);

    grp_reduce_3_fu_592 : component reduce_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_3_fu_592_ap_return,
        ap_ce => grp_reduce_3_fu_592_ap_ce);
    ...
    ap_return <= std_logic_vector(unsigned(grp_reduce_3_fu_592_ap_return) + unsigned(grp_reduce_3_fu_524_ap_return));

    grp_reduce_3_fu_524_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp67, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp67))) then 
            grp_reduce_3_fu_524_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_3_fu_524_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_reduce_3_fu_592_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp68)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp68))) then 
            grp_reduce_3_fu_592_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_3_fu_592_ap_ce <= ap_const_logic_0;
        end if; 
    end process;
