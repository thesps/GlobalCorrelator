...
architecture behav of reduce_6 is 
    ...
    signal p_Val2_4_reg_1309 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_ce_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                p_Val2_4_reg_1309 <= grp_reduce_1_fu_1168_ap_return;
                p_Val2_s_reg_1304 <= grp_reduce_1_fu_1036_ap_return;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln703_fu_1300_p2 <= std_logic_vector(unsigned(p_Val2_4_reg_1309) + unsigned(p_Val2_s_reg_1304));
    ...
    grp_reduce_1_fu_1036_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp132, ap_ce_reg)
    begin
    ...
    grp_reduce_1_fu_1168_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp133, ap_ce_reg)
    begin
