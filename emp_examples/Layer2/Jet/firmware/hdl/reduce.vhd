...
architecture behav of reduce is 
    ...
    signal call_ret1_reduce_2_fu_210_ap_return_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal call_ret1_reduce_2_fu_210_ap_return_1 : STD_LOGIC_VECTOR (9 downto 0);
    signal call_ret1_reduce_2_fu_210_ap_return_2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal call_ret2_reduce_2_fu_238_ap_return_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal call_ret2_reduce_2_fu_238_ap_return_1 : STD_LOGIC_VECTOR (9 downto 0);
    signal call_ret2_reduce_2_fu_238_ap_return_2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal call_ret1_reduce_2_fu_210_ap_ready : STD_LOGIC;
    signal call_ret2_reduce_2_fu_238_ap_ready : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal icmp_ln891_fu_286_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln891_fu_290_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    call_ret1_reduce_2_fu_210 : component reduce_2
    port map (
        ap_ready => call_ret1_reduce_2_fu_210_ap_ready,
        ...
        ap_return_0 => call_ret1_reduce_2_fu_210_ap_return_0,
        ap_return_1 => call_ret1_reduce_2_fu_210_ap_return_1,
        ap_return_2 => call_ret1_reduce_2_fu_210_ap_return_2);

    call_ret2_reduce_2_fu_238 : component reduce_2
    port map (
        ap_ready => call_ret2_reduce_2_fu_238_ap_ready,
        ...
        ap_return_0 => call_ret2_reduce_2_fu_238_ap_return_0,
        ap_return_1 => call_ret2_reduce_2_fu_238_ap_return_1,
        ap_return_2 => call_ret2_reduce_2_fu_238_ap_return_2);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1))) then
                Particle_hwPt_V_read_reg_342 <= call_ret1_reduce_2_fu_210_ap_return_0;
                b_hwPt_V_read_assign_reg_354 <= call_ret2_reduce_2_fu_238_ap_return_0;
                call_ret1_reg_336_1 <= call_ret1_reduce_2_fu_210_ap_return_1;
                call_ret1_reg_336_2 <= call_ret1_reduce_2_fu_210_ap_return_2;
                call_ret2_reg_348_1 <= call_ret2_reduce_2_fu_238_ap_return_1;
                call_ret2_reg_348_2 <= call_ret2_reduce_2_fu_238_ap_return_2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    icmp_ln891_fu_286_p2 <= "1" when (unsigned(Particle_hwPt_V_read_reg_342) < unsigned(b_hwPt_V_read_assign_reg_354)) else "0";
    select_ln84_1_fu_302_p3 <= 
        call_ret1_reg_336_1 when (xor_ln891_fu_290_p2(0) = '1') else 
        call_ret2_reg_348_1;
    select_ln84_2_fu_310_p3 <= 
        call_ret1_reg_336_2 when (xor_ln891_fu_290_p2(0) = '1') else 
        call_ret2_reg_348_2;
    select_ln84_fu_296_p3 <= 
        Particle_hwPt_V_read_reg_342 when (xor_ln891_fu_290_p2(0) = '1') else 
        b_hwPt_V_read_assign_reg_354;
    xor_ln891_fu_290_p2 <= (icmp_ln891_fu_286_p2 xor ap_const_lv1_1);
end behav;
