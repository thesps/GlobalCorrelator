...
architecture behav of reduce_19 is 
    ...
    signal grp_reduce_14_fu_402_ap_return_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_14_fu_402_ap_return_1 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_reduce_14_fu_402_ap_return_2 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_reduce_14_fu_402_ap_ce : STD_LOGIC;
    ...
    signal grp_reduce_14_fu_454_ap_return_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_14_fu_454_ap_return_1 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_reduce_14_fu_454_ap_return_2 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_reduce_14_fu_454_ap_ce : STD_LOGIC;
    ...
    signal icmp_ln1496_fu_530_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln1496_fu_536_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    grp_reduce_14_fu_402 : component reduce_14
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return_0 => grp_reduce_14_fu_402_ap_return_0,
        ap_return_1 => grp_reduce_14_fu_402_ap_return_1,
        ap_return_2 => grp_reduce_14_fu_402_ap_return_2,
        ap_ce => grp_reduce_14_fu_402_ap_ce);

    grp_reduce_14_fu_454 : component reduce_14
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return_0 => grp_reduce_14_fu_454_ap_return_0,
        ap_return_1 => grp_reduce_14_fu_454_ap_return_1,
        ap_return_2 => grp_reduce_14_fu_454_ap_return_2,
        ap_ce => grp_reduce_14_fu_454_ap_ce);
    ...
    grp_reduce_14_fu_402_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp51, ap_ce)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp51) and (ap_const_logic_1 = ap_ce))) then 
            grp_reduce_14_fu_402_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_14_fu_402_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_reduce_14_fu_454_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp52)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp52))) then 
            grp_reduce_14_fu_454_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_14_fu_454_ap_ce <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln1496_fu_530_p2 <= "1" when (unsigned(grp_reduce_14_fu_402_ap_return_0) < unsigned(grp_reduce_14_fu_454_ap_return_0)) else "0";
    select_ln84_3_fu_550_p3 <= 
        grp_reduce_14_fu_402_ap_return_1 when (xor_ln1496_fu_536_p2(0) = '1') else 
        grp_reduce_14_fu_454_ap_return_1;
    select_ln84_4_fu_558_p3 <= 
        grp_reduce_14_fu_402_ap_return_2 when (xor_ln1496_fu_536_p2(0) = '1') else 
        grp_reduce_14_fu_454_ap_return_2;
    select_ln84_fu_542_p3 <= 
        grp_reduce_14_fu_402_ap_return_0 when (xor_ln1496_fu_536_p2(0) = '1') else 
        grp_reduce_14_fu_454_ap_return_0;
    xor_ln1496_fu_536_p2 <= (icmp_ln1496_fu_530_p2 xor ap_const_lv1_1);
end behav;
