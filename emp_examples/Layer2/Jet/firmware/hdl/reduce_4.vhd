...
architecture behav of reduce_4 is 
    ...
    signal icmp_ln891_fu_64_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln891_fu_70_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    icmp_ln891_fu_64_p2 <= "1" when (unsigned(x_0_hwPt_V_read) < unsigned(x_1_hwPt_V_read)) else "0";
    select_ln84_5_fu_84_p3 <= 
        x_0_hwEta_V_read when (xor_ln891_fu_70_p2(0) = '1') else 
        x_1_hwEta_V_read;
    select_ln84_6_fu_92_p3 <= 
        x_0_hwPhi_V_read when (xor_ln891_fu_70_p2(0) = '1') else 
        x_1_hwPhi_V_read;
    select_ln84_fu_76_p3 <= 
        x_0_hwPt_V_read when (xor_ln891_fu_70_p2(0) = '1') else 
        x_1_hwPt_V_read;
    xor_ln891_fu_70_p2 <= (icmp_ln891_fu_64_p2 xor ap_const_lv1_1);
end behav;
