...
entity simple_puppi_hw_prcU_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 11; 
...
architecture rtl of simple_puppi_hw_prcU_rom is 
...
entity simple_puppi_hw_prcU is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of simple_puppi_hw_prcU is
    component simple_puppi_hw_prcU_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    simple_puppi_hw_prcU_rom_U :  component simple_puppi_hw_prcU_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
