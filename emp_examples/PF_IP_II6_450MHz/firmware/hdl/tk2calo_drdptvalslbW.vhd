...
entity tk2calo_drdptvalslbW_rom is 
    generic(
             DWIDTH     : integer := 17; 
             AWIDTH     : integer := 9; 
...
architecture rtl of tk2calo_drdptvalslbW_rom is 
...
entity tk2calo_drdptvalslbW is
    generic (
...
architecture arch of tk2calo_drdptvalslbW is
    component tk2calo_drdptvalslbW_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    tk2calo_drdptvalslbW_rom_U :  component tk2calo_drdptvalslbW_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
